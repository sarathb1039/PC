...
public class RenewPolicy_BC {
	
	public static String sheetname = "RenewPolicy_BC";
	 ...
	 * @throws Exception
	 */
	public Boolean SCRRenewPolicy_BC() throws Exception{
	...
	public boolean AddPremium(String value) throws Exception 
	{
		...
		try
		{
			status = common.ActionOnTable(Common.o.getObject("eleRenewalPremiumTable"), 1,3,sValue[0], "div");
	...
	public boolean AddPolicyType(String value) throws Exception 
	{
		...
		try
		{
			status = common.ActionOnTable(Common.o.getObject("eleRenewalPremiumTable"), 1,1,sValue[0], "div");
	...
	public boolean EffDate(String strValue) throws Exception
	{
		...
		try
		{
			...
			case "EXP_1YEARGREATER":
				...
				status = common.SafeAction(Common.o.getObject("eleExpiration_Date_BC"), strDate, "edt");
				if (status == true)
				{
			...
			case "EFF_BACKDATED_2MONTHS":
				...
				status = common.SafeAction(Common.o.getObject("edtEffective_Date_BC"), strDate, "edt");
				if (status == true)
				{
					HTML.fnInsertResult(PCThreadCache.getInstance().getProperty("testcasename"), PCThreadCache.getInstance().getProperty("methodName"), "Validate date in first row", "Value in field -" +strDate, "PASS");	
				}
