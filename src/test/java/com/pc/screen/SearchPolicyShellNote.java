...
public class SearchPolicyShellNote {
	
	public static String sheetname = "SearchPolicyShellNote";
	Common common = CommonManager.getInstance().getCommon();
	private WebDriver driver = ManagerDriver.getInstance().getWebDriver();
	static Logger logger =Logger.getLogger(sheetname);
	
	public Boolean SCRSearchPolicyShellNote() throws Exception{
		...
		if(common.WaitUntilClickable(Common.o.getObject("eleShellPolicyNotes"),  Integer.valueOf(HTML.properties.getProperty("VERYLONGWAIT"))))
		{
			logger.info("System displayed Policy Shell Search Note Page");  
			HTML.fnInsertResult(PCThreadCache.getInstance().getProperty("testcasename"), PCThreadCache.getInstance().getProperty("methodName"), "System should display Policy Shell Search Note Page","System displayed Policy Shell Search Note Page", "PASS");
			status = true;
		}
		else
		{
			logger.info("System not displayed Policy Shell Search Note Page");
			HTML.fnInsertResult(PCThreadCache.getInstance().getProperty("testcasename"), PCThreadCache.getInstance().getProperty("methodName"), "System should display Policy Shell Search Note Page","System not displayed Policy Shell Search Note Page", "FAIL");
			status = false;
		}
		return status;
	}
