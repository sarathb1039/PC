//@Component - This Component used to Edit the Policy Note Information
...
public class EditPolicyNote {
	
	public static String sheetname = "EditPolicyNote";
	Common common = CommonManager.getInstance().getCommon();
	private WebDriver driver = ManagerDriver.getInstance().getWebDriver();
	static Logger logger =Logger.getLogger(sheetname);
	
	public Boolean SCREditPolicyNote() throws Exception{
		...
		{
			logger.info("System displayed Policy Note Search Page");  
			HTML.fnInsertResult(PCThreadCache.getInstance().getProperty("testcasename"), PCThreadCache.getInstance().getProperty("methodName"), "System should display Policy Note Search Page","System displayed Policy Note Search Page", "PASS");
			status = true;
		}
		else
		{
			logger.info("System not displayed Policy Note Search Page");
			HTML.fnInsertResult(PCThreadCache.getInstance().getProperty("testcasename"), PCThreadCache.getInstance().getProperty("methodName"), "System should display Policy Note Search Page","System not displayed Policy Note Search Page", "FAIL");
			status = false;
		}
		return status;
	}
