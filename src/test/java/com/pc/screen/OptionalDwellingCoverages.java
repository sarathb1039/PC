...
public class OptionalDwellingCoverages{
	
		public static String sheetname = "OptionalDwellingCoverages";
		static Logger logger =Logger.getLogger(sheetname);
		Common common = CommonManager.getInstance().getCommon();
		private WebDriver driver = ManagerDriver.getInstance().getWebDriver();
		public Boolean SCROptionalDwellingCoverages() throws Exception{
						Boolean status = true;
