...
public class ChangePolicy_BC {
	
	public static String sheetname = "ChangePolicy_BC";
	 ...
	 * @throws Exception
	 */
	public Boolean SCRChangePolicy_BC() throws Exception{
	...
	public boolean EffDate(String strValue) throws Exception
	{
		...
		try
		{
			...
			case "EXP_1YEARGREATER":
				...
				status = common.SafeAction(Common.o.getObject("eleExpiration_DateBC"), strDate, "edt");
				if (status == true)
				{
			...
			case "EFF_BACKDATED_2MONTHS":
				...
				status = common.SafeAction(Common.o.getObject("edtEffective_DateBC"), strDate, "edt");
				if (status == true)
				{
					HTML.fnInsertResult(PCThreadCache.getInstance().getProperty("testcasename"), PCThreadCache.getInstance().getProperty("methodName"), "Validate date in first row", "Value in field -" +strDate, "PASS");	
				}
			...
			case "EFF_TODAY":
				...
				strDate = (Date.get(Calendar.MONTH)+1)+"/"+(Date.get(Calendar.DATE)+"/"+(Date.get(Calendar.YEAR)));
				status = common.SafeAction(Common.o.getObject("edtChangeEffectiveDate"), strDate, "edt");
				if (status == true)
				{
					HTML.fnInsertResult(PCThreadCache.getInstance().getProperty("testcasename"), PCThreadCache.getInstance().getProperty("methodName"), "Validate date in first row", "Value in field -" +strDate, "PASS");	
				}
